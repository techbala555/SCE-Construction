...
export const metadata: Metadata = {
  title: "Real Estate Plot Promotion in Coimbatore",
  description:
    "SCE Developers offers approved residential plot promotion and layout development in Coimbatore with clear legal titles and ready infrastructure.",
  alternates: {
    canonical: "https://www.scedevelopers.in/services/plot-promotion",
  },
  openGraph: {
    title: "Real Estate Plot Promotion in Coimbatore | SCE Developers",
    description:
      "SCE Developers offers approved residential plot promotion and layout development in Coimbatore with clear legal titles and ready infrastructure.",
    url: "https://www.scedevelopers.in/services/plot-promotion",
    siteName: "SCE Developers",
    locale: "en_IN",
    type: "website",
    images: [
      {
        url: "/images/projects/plot-development.jpg",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    description:
      "SCE Developers offers approved residential plot promotion and layout development in Coimbatore with clear legal titles and ready infrastructure.",
    images: ["/images/projects/plot-development.jpg"],
  },
};
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    },
    {
      "@type": "ListItem",
      position: 3,
      name: "Real Estate Plot Promotion",
      item: "https://www.scedevelopers.in/services/plot-promotion",
    },
  ],
};
...
const serviceJsonLd = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Real Estate Plot Promotion in Coimbatore",
  serviceType: "Plot Promotion",
  description:
    "SCE Developers offers approved residential plot promotion and layout development in Coimbatore with clear legal titles and ready infrastructure.",
  provider: {
...
const plotService = serviceDetails["real-estate"];

const plotProjects = projects.filter(
  (p) => p.category === "Layout Development" || p.id === "plot-development"
);

export default function PlotPromotionPage() {
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col font-sans">
      ...
      <main className="flex-1 pt-24 sm:pt-28 md:pt-32">
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <div>
              ...
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-primary/10 border border-primary/20 text-primary text-xs font-semibold mb-5">
                <Building className="w-4 h-4" strokeWidth={2} aria-hidden="true" />
                <span>Approved Layout Plots</span>
              </div>

              <h1 className="heading-xl text-3xl sm:text-4xl lg:text-5xl text-foreground mb-6 leading-tight">
                Real Estate Plot Promotion in{" "}
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
                ...
                >
                  <span>View Developed Layouts</span>
                </a>
              </div>
            </div>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="text-center max-w-3xl mx-auto mb-10">
              ...
              <h2 className="heading-lg text-2xl sm:text-3xl lg:text-4xl text-foreground mb-4">
                Approved Residential Plots with <span className="text-gold-gradient">Clear Legal Titles</span>
              </h2>
            </div>

            <div className="grid sm:grid-cols-2 gap-4 sm:gap-6 mt-8">
              {plotService.keyBenefits.map((benefit) => (
                <div
                  key={benefit}
        ...
        <section className="py-14 sm:py-20 px-4 sm:px-6 lg:px-8 bg-surface border-b border-border/70">
          <div className="max-w-7xl mx-auto">
            <div className="text-center max-w-3xl mx-auto mb-12">
              ...
              <h2 className="heading-lg text-2xl sm:text-3xl lg:text-4xl text-foreground mb-4">
                Plot Promotion & <span className="text-gold-gradient">Development Solutions</span>
              </h2>
            </div>

            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {plotService.items.map((item, index) => (
                <div
                  key={item}
                ...
                >
                  <div>
                    ...
                    <p className="text-muted text-xs sm:text-sm leading-relaxed">
                      Legal title verification, layout planning, and site infrastructure for {item.toLowerCase()}.
                    </p>
                  </div>
                </div>
              ))}
        ...
        {/* FEATURED PROJECTS */}
        <section id="projects" className="py-14 sm:py-20 px-4 sm:px-6 lg:px-8 bg-surface border-b border-border/70">
          <div className="max-w-7xl mx-auto">
            <div className="text-center max-w-3xl mx-auto mb-12">
              <div className="flex items-center justify-center gap-3 mb-4">
                <div className="divider-gold" />
              ...
              <h2 className="heading-lg text-2xl sm:text-3xl lg:text-4xl text-foreground mb-4">
                Developed Plot <span className="text-gold-gradient">Layouts</span>
              </h2>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 sm:gap-8 max-w-4xl mx-auto">
              {plotProjects.map((project) => (
                <div
                  key={project.id}
                  className="group rounded-2xl overflow-hidden bg-background border border-border shadow-sm flex flex-col justify-between"
                >
        ...
        <section className="py-14 sm:py-20 px-4 sm:px-6 lg:px-8 bg-background border-b border-border/70">
          <div className="max-w-7xl mx-auto">
            <div className="text-center max-w-3xl mx-auto mb-12">
              ...
              <h2 className="heading-lg text-2xl sm:text-3xl lg:text-4xl text-foreground mb-4">
                Why Choose SCE Developers <span className="text-gold-gradient">for Plot Promotion</span>
              </h2>
            </div>

            <div className="grid sm:grid-cols-3 gap-6">
              {plotService.whyChooseUs.map((reason) => (
                <div
                  key={reason}
                  className="p-6 rounded-2xl bg-surface border border-border flex items-start gap-4 shadow-sm"
                >
        ...
        <section className="py-14 sm:py-20 px-4 sm:px-6 lg:px-8 bg-surface border-b border-border/70">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="p-6 sm:p-8 rounded-2xl bg-background border border-border shadow-sm max-w-xl mx-auto text-left space-y-4 text-xs sm:text-sm">
        ...
        {/* CONTACT CTA */}
        <section className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-background text-center">
          <div className="max-w-3xl mx-auto">
            <h2 className="heading-lg text-3xl sm:text-4xl text-foreground mb-4">
              Find the Right <span className="text-gold-gradient">Plot Opportunity</span>
            </h2>
            <p className="text-muted body-relaxed text-sm sm:text-base mb-8">
              Contact our real estate and layout promotion team today to learn about approved plot layout availability.
            </p>
