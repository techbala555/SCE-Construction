          ...
          {isOpen && (
            ...
            >
              ...
              >
                ...
                <div className="p-5 sm:p-7 border-b border-border/80 flex items-start justify-between gap-4 flex-shrink-0 relative">
                  <div>
                    ...
                    <h3 id="lead-popup-heading" className="text-lg sm:text-2xl font-bold text-foreground heading-md leading-tight">
                  ...
                  <button
                    ...
                    className="w-10 h-10 min-w-[40px] flex items-center justify-center rounded-xl bg-surface-elevated text-foreground
                               hover:bg-primary/20 hover:text-primary transition-all duration-200 border border-border/60 flex-shrink-0 cursor-pointer"
                    ...
                    <div className="pt-2 flex flex-col sm:flex-row items-center gap-3">
                      ...
                      <button
                        ...
                        className="w-full sm:flex-1 min-h-[50px] py-3.5 text-sm font-semibold rounded-xl
                                   ...
                                   hover:border-primary/40 hover:bg-primary/10 transition-all duration-200 cursor-pointer"
                      >
                        Continue Browsing
                      </button>
                    </div>
